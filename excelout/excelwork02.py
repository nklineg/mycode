...
def get_ip_data():
    ...
    input_manufacturer = input("What is the manufacturer of the device? ")
    input_addlt_cpu = input("Is additional CPU required? ")
    
    d = {"IP": input_ip, "driver": input_driver, "manufacturer": input_manufacturer, "CPU": input_addlt_cpu}
    return d
